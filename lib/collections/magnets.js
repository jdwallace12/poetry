...
if (Meteor.isClient) {
    ...
    replaceWith: ['fiddle', 'fun', 'stupendous', 'puppies', 'happy', 'kittens', 'silly', 'coffee', 'IE', 'dancing', 'a', 'the', 'at', 'was', 'there', 'tired', 'sleepy', 'hungry', 'full', 'editor', 'pancakes', 'butter', 'syrup', 'source', 'open', 'clouds', 'sunshine', 'rainbows', 'unicorns', 'love', 'kind', 'lunch', 'fragrant', 'grumpy', 'hipsters', 'fedora', 'flowers', 'birds', 'apm', 'developer']
    });   
